    ...
    public void systemReady(IAppOpsService appOps) {
        ...
        if (mButtonBrightnessSupport){
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.OMNI_CUSTOM_BUTTON_BRIGHTNESS),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.OMNI_CUSTOM_BUTTON_USE_SCREEN_BRIGHTNESS),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.OMNI_BUTTON_BACKLIGHT_ENABLE),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.OMNI_HARDWARE_KEYS_DISABLE),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.OMNI_BUTTON_BACKLIGHT_TIMEOUT),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.OMNI_BUTTON_BACKLIGHT_ON_TOUCH_ONLY),
                    false, mSettingsObserver, UserHandle.USER_ALL);
        }
    }
    ...
    private void updateButtonLightSettings() {
        ...
        if (mButtonBrightnessSupport){
            mCustomButtonBrightness = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.OMNI_CUSTOM_BUTTON_BRIGHTNESS,
                    mCustomButtonBrightness, UserHandle.USER_CURRENT);
            mButtonUseScreenBrightness = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.OMNI_CUSTOM_BUTTON_USE_SCREEN_BRIGHTNESS,
            ...
            mButtonBacklightOnTouchOnly = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.OMNI_BUTTON_BACKLIGHT_ON_TOUCH_ONLY,
                    0, UserHandle.USER_CURRENT) != 0;
